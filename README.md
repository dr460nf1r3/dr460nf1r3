...
My newest project is a [fully self-documented NixOS flake](https://github.com/dr460nf1r3/device-configurations) for my personal machines. This includes a self-destructing rootfs on ZFS for my laptop, several other setups as well as automated building and deployment of custom derivations to [Cachix](https://cachix.org/) via GitHub actions. It uses the GNOME desktop and is fully Gruvbox themed via [Stylix](https://github.com/danth/stylix).
